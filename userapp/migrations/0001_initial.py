    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('seller', 'seller'), ('admin', 'admin')], default='user', max_length=30)),
                ...
                ('profile_image', models.ImageField(blank=True, default=None, null=True, upload_to='profileImage')),
                ('id_card_image', models.ImageField(blank=True, default=None, null=True, upload_to='IDcard')),
